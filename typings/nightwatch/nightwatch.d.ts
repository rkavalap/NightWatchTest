...
///<reference path="../nightwatch-custom/custom-commands.d.ts"/>
///<reference path="../nightwatch-custom/page-objects.d.ts"/>
...
export interface NightWatchClient {
    ...
    * @returns {} 
    */
    elementIdCssProperty: (id: string, cssPropertyName: string, callback?: () => void) => NightWatchBrowser;
    ...
    * @returns {} 
    */
    elementIdElements: (id: string, using: string, value: string, callback?: () => void) => NightWatchBrowser;
